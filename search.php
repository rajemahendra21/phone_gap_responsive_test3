...
<section class="wrapper">
    ...
    <?php include "top_menu.php" ?>
    	<div class="body_mid inner gallery search_gallery">
            <h1 class="how_to"><span>Search Result</span>
            <div class="search_box"><span>
			Search By Name:</span><input type='text' name='search' id='search' >
			<input type="button" class="search_btn" value="" onclick="advance_seach();"></div>
            </h1>
            ...
            <div class="all_videos search_video">
			...
			<div class="pagination_inner">
				...
				<?php if($page > 1)
					{
						$prev=$page-1;
						echo "<div class='prev'><a href='search.php?page=$prev&search=$search'>Prev</a></div>";
					}		?>
					<?php for ($i=1; $i<=$total_pages; $i++) {
						if($page == $i){ $active = 'active';} else { $active = ''; }
						echo "<a class='page_list $active' href='search.php?page=".$i."&search=$search'>".$i."</a> ";
					...
					{
						$next=$page+1;
						echo  "<div class='next'><a href='search.php?page=$next&search=$search' >Next</a></div>";
					}
			?>
			</div>
			</div>
